...
public class UpdateDataActivity extends Activity {
	...
	private AVObject shengHuoBang = new AVObject("shengHuoBang");
...
//	        		}
	...
	private void updateCharge(){
		...
		while(cursor.moveToNext()){
    		...
    		shengHuoBang.put("chargeID", id);
    		shengHuoBang.put("year", year);
    		shengHuoBang.put("month", month);
    		shengHuoBang.put("day", day);
    		shengHuoBang.put("type", type);
    		shengHuoBang.put("sum", sum);
    		shengHuoBang.put("des", des);
    		
    		ChargeObject.put(openID, shengHuoBang);
	...
	private void updateUnforget(){
		...
		while(cursor.moveToNext()){
    		...
    		shengHuoBang.put("unforgetID", id);
    		shengHuoBang.put("year", year);
    		shengHuoBang.put("month", month);
    		shengHuoBang.put("day", day);
    		shengHuoBang.put("hour", hour);
    		shengHuoBang.put("minute", minute);
    		shengHuoBang.put("second", second);
    		shengHuoBang.put("name", name);
    		shengHuoBang.put("soundFileName", soundFileName);
    		
    		UnforgetObject.put(openID, shengHuoBang);
	...
	private void updatePassword(){
		...
		while(cursor.moveToNext()){
    		...
    		shengHuoBang.put("passwordID", id);
    		shengHuoBang.put("name", name);
    		shengHuoBang.put("password", password);
    		shengHuoBang.put("soundFileName", soundFileName);
    		
    		PasswordObject.put(openID, shengHuoBang);
